...
## 功能
- Dashboard（首頁總覽：淨資產、資產／負債概況）
- 資產管理
- 負債管理（含貸款中心：房貸／車貸／信貸的每月應繳與剩餘期數追蹤）
- 收入管理
- 固定支出
- 每月生活費
- 財務目標（Goals）
...
| `nw_debts` | 負債清單（房貸、車貸、信貸、信用卡、其他）。房貸／車貸／信貸額外含 `monthlyPayment`（每月應繳）與 `remainingMonths`（剩餘期數） | Array |
...
## 未來規劃（Roadmap）
- [ ] 貸款攤還方式（本息平均攤還／本金平均攤還）與提前還款試算（v2.5 規劃中）
