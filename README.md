...
## 功能
- Dashboard（首頁總覽：新手引導、資料完整度、快速新增、淨資產、資產／負債概況、房貸概況、財務健康分析）
- 資產管理
...
- 每月生活費
- 財務目標（Goals）
- 財務健康分析（單一整合卡片：財務健康分數／等級＋負債比／儲蓄率／緊急預備金月數／房貸負擔率／財務目標完成率，含依風險排序的規則式建議）
- 資產配置分析（占比列表）
- 新手引導（Onboarding）：首次使用且無資料時顯示歡迎卡片，完成一次後不再出現
- 一致風格的空資料提示卡：資產／負債／收入／固定支出／Goals 頁面無資料時顯示用途說明與建立按鈕
